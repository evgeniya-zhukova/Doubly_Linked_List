...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //testing a creation of an empty linked list
        ...
        //testing a comparision
        System.out.println(hi5.compareTo(hi4));
        System.out.println(hi2.compareTo(hi1));

        //adding a digit to the front of the number (at the end of the list)
        HugeInteger hi12 = new HugeInteger("-0012345");
